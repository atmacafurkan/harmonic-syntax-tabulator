...
trial %>% Agree() %>% print("lb","ac","ft","n_dominator")

trial %>% print("lb","ac","ft","n_dominator")

# merge all the possible phrases from the numeration

x <- lapply(my_num[-1], function(i) Merge(i, my_num[[1]]))

x[[1]] %>% print("it","mc","lb","ft","ac","n_dominator")
