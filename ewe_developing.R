...
df_unacc %>% lapply(tabulate_latex, my_file = "./latex_tables/basic_unacc_tables.txt")

df_ext %>% lapply(tabulate_latex, my_file = "./latex_tables/basic_external_tables.txt")

df_ewe_def %>% lapply(tabulate_latex, my_file = "./latex_tables/ewe_default_tables.txt")

df_ewe_matrix %>% lapply(tabulate_latex, my_file = "./latex_tables/ewe_matrix_tables.txt")
